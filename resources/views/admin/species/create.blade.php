                ...
                <div class="col-md-10">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title" id="basic-layout-colored-form-control">Create Species</h4>
                            <p class="mb-0"></p>
                        </div>
                        <div class="col-lg-12">
                        ...
                        <div class="card-body">
                            <div class="px-3">
          {{ Form::open(array('route'=>'species.store', 'method' => 'POST', 'class'=>'horizontal-form', 'id'=>'frmCreate', 'name'=>'frmCreate', 'autocomplete'=>'off', 'enctype'=>'multipart/form-data')) }}
