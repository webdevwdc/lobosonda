                ...
                <div class="col-md-10">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title" id="basic-layout-colored-form-control">Create Trip</h4>
                            <p class="mb-0"></p>
                        </div>
                        <div class="col-lg-12">
                        ...
                        <div class="card-body">
                            <div class="px-3">
                                  {{ Form::open(array('route'=>['trip.store'], 'method' => 'POST', 'class'=>'horizontal-form', 'id'=>'frmCreate', 'name'=>'frmCreate', 'autocomplete'=>'off', 'enctype'=>'multipart/form-data')) }}
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group @if(!empty($errors->first('date'))) has-error @endif">
                                    ...
                                    {!! Form::text('date',null,['class'=>'form-control pickadate required', 'placeholder'=>'date','id'=>'date', 'placeholder'=>'Date']) !!}
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    {!! Form::select('guide_id',$guides,null,['class'=>'form-control required', 'placeholder'=>'guide_id','id'=>'guide_id', 'placeholder'=>'Guide']) !!}
                          ...
                          <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    {!! Form::select('skipper_id',$skippers,null,['class'=>'form-control required', 'placeholder'=>'skipper_id','id'=>'skipper_id', 'placeholder'=>'Skipper']) !!}
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="watchman_id" class="control-label" @if(!empty($errors->first('watchman_id'))) has-error @endif>
                                     Watchman  <span class="requirewatchman_id"></span>
                                    </label>
                                    {!! Form::select('watchman_id',$watchmans,null,['class'=>'form-control required', 'placeholder'=>'watchman_id','id'=>'watchman_id', 'placeholder'=>'Watchman']) !!}
