            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="px-3">
                                 {!! Form::open(array('route'=>'changePassword.store','class'=>'form-horizontal form-validate','method'=>'post'))!!}
                                <div class="form-body pal">
                                    
                                     <div class="form-group">
                                        <label class="col-md-3 control-label" for="old_password">Old password <span class="require">*</span></label>
                                        <div class="col-md-9">
                                        
                                            <input type="password" name="old_password" class="form-control required"  id="old_password" placeholder="Old Password">
